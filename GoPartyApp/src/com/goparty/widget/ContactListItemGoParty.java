...
public class ContactListItemGoParty extends LinearLayout
{
	...
	*/
	...
	public ContactListItemGoParty(Context context) {
		super(context);
	}

	public ContactListItemGoParty(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
